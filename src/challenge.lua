...
SMODS.Challenge {
  ...
  restrictions = {
	...
	banned_tags = {},
	banned_other = {
		{id = 'bl_ox', type = 'blind'}, {id = 'bl_hook', type = 'blind'}, {id = 'bl_mouth', type = 'blind'}, 
		{id = 'bl_fish', type = 'blind'}, {id = 'bl_club', type = 'blind'}, {id = 'bl_manacle', type = 'blind'}, 
		{id = 'bl_tooth', type = 'blind'}, {id = 'bl_wall', type = 'blind'}, {id = 'bl_house', type = 'blind'}, 
		{id = 'bl_mark', type = 'blind'}, {id = 'bl_wheel', type = 'blind'}, {id = 'bl_arm', type = 'blind'}, 
		{id = 'bl_psychic', type = 'blind'}, {id = 'bl_goad', type = 'blind'}, {id = 'bl_water', type = 'blind'}, 
		{id = 'bl_eye', type = 'blind'}, {id = 'bl_plant', type = 'blind'}, {id = 'bl_needle', type = 'blind'}, 
		{id = 'bl_head', type = 'blind'}, {id = 'bl_window', type = 'blind'}, {id = 'bl_serpent', type = 'blind'}, 
		{id = 'bl_pillar', type = 'blind'}, {id = 'bl_flint', type = 'blind'}
	}
  },
  button_colour = G.C.BLACK,
  consumeables = {},
